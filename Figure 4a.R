...
boxplot(out.lB1,  col = c("#F48F0B", "#0BF488"), font.family = "Times New Roman")
title(outer=outer,adj=adj,main="B1",cex.main=cex,col="black",font=1,line=line)
boxplot(out.lB2,  col = c("#F48F0B", "#0BF488"), font.family = "Times New Roman")
title(outer=outer,adj=adj,main="B2",cex.main=cex,col="black",font=1,line=line)
boxplot(out.lB3,  col = c("#F48F0B", "#0BF488"), font.family = "Times New Roman")
title(outer=outer,adj=adj,main="B3",cex.main=cex,col="black",font=1,line=line)
boxplot(out.lB4,  col = c("#F48F0B", "#0BF488"), font.family = "Times New Roman")
title(outer=outer,adj=adj,main="B4",cex.main=cex,col="black",font=1,line=line)
boxplot(out.lB5,  col = c("#F48F0B", "#0BF488"), font.family = "Times New Roman")
...
corrplot(mB, method = "number", tl.col = "black", tl.srt = 30)
boxplot(mB)
