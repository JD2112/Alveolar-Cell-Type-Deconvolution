...
StatiscalAnalysisHLADR <- function(StatiscalAnalysisHLADR){
  ...
  # Create a second file for Mann-Whitney-Wilcoxon test
...
StatiscalAnalysisCD3 <- function(StatiscalAnalysisCD3){
  # CD3 data
...
CompareAnalysisRingh <- function(CompareAnalysisRingh){
